...
function handleNavClick(id: string) {
  if (activeTab.value === id) {
    layoutStore.leftSidebarVisible = !layoutStore.leftSidebarVisible;
  } else {
    activeTab.value = id;
...
<template>
  <aside class="sidebar">
    ...
    <Transition name="slide-left">
      <div v-show="layoutStore.leftSidebarVisible" class="sidebar-content">
...
.sidebar-content {
  width: var(--roc-sidebar-content-width);
  height: var(--roc-sidebar-height);
